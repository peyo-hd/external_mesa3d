                                    ...
                                    const struct V3D41_LOAD_TILE_BUFFER_GENERAL * restrict values)
{
   ...
   cl[ 3] = __gen_uint(values->r_b_swap, 4, 4) |
            __gen_uint(values->channel_reverse, 3, 3) |
            __gen_uint(values->force_alpha_1, 2, 2) |
...
#define V3D41_SET_INSTANCEID_length            5
#ifdef __gen_unpack_address
static inline void
...
#define V3D41_SET_PRIMITIVEID_length           5
#ifdef __gen_unpack_address
static inline void
                                         ...
                                         const struct V3D41_TILE_RENDERING_MODE_CFG_COLOR * restrict values)
{
   ...
   cl[ 5] = __gen_uint(values->pad, 4, 31) |
            __gen_uint(values->render_target_3_clamp, 2, 3) |
            __gen_uint(values->render_target_3_internal_type, 6, 9) >> 8;

   cl[ 6] = __gen_uint(values->pad, 4, 31) >> 8;

   cl[ 7] = __gen_uint(values->pad, 4, 31) >> 16;

   cl[ 8] = __gen_uint(values->pad, 4, 31) >> 24;
                                        ...
                                        const struct V3D41_GEOMETRY_SHADER_STATE_RECORD * restrict values)
{
   ...
   cl[ 0] = __gen_address_offset(&values->geometry_bin_mode_shader_code_address) |
            __gen_uint(values->geometry_bin_mode_shader_4_way_threadable, 0, 0) |
            __gen_uint(values->geometry_bin_mode_shader_start_in_final_thread_section, 1, 1) |
            __gen_uint(values->geometry_bin_mode_shader_propagate_nans, 2, 2);
   ...
   cl[ 8] = __gen_address_offset(&values->geometry_render_mode_shader_code_address) |
            __gen_uint(values->geometry_render_mode_shader_4_way_threadable, 0, 0) |
            __gen_uint(values->geometry_render_mode_shader_start_in_final_thread_section, 1, 1) |
            __gen_uint(values->geometry_render_mode_shader_propagate_nans, 2, 2);
                                            ...
                                            const struct V3D41_TESSELLATION_SHADER_STATE_RECORD * restrict values)
{
   ...
   cl[ 0] = __gen_address_offset(&values->tessellation_bin_mode_control_shader_code_address) |
            __gen_uint(values->tessellation_bin_mode_control_shader_4_way_threadable, 0, 0) |
            __gen_uint(values->tessellation_bin_mode_control_shader_start_in_final_thread_section, 1, 1) |
            __gen_uint(values->tessellation_bin_mode_control_shader_propagate_nans, 2, 2);
   ...
   cl[ 8] = __gen_address_offset(&values->tessellation_render_mode_control_shader_code_address) |
            __gen_uint(values->tessellation_render_mode_control_shader_4_way_threadable, 0, 0) |
            __gen_uint(values->tessellation_render_mode_control_shader_start_in_final_thread_section, 1, 1) |
            __gen_uint(values->tessellation_render_mode_control_shader_propagate_nans, 2, 2);
   ...
   cl[16] = __gen_address_offset(&values->tessellation_bin_mode_evaluation_shader_code_address) |
            __gen_uint(values->tessellation_bin_mode_evaluation_shader_4_way_threadable, 0, 0) |
            __gen_uint(values->tessellation_bin_mode_evaluation_shader_start_in_final_thread_section, 1, 1) |
            __gen_uint(values->tessellation_bin_mode_evaluation_shader_propagate_nans, 2, 2);
   ...
   cl[24] = __gen_address_offset(&values->tessellation_render_mode_evaluation_shader_code_address) |
            __gen_uint(values->tessellation_render_mode_evaluation_shader_4_way_threadable, 0, 0) |
            __gen_uint(values->tessellation_render_mode_evaluation_shader_start_in_final_thread_section, 1, 1) |
            __gen_uint(values->tessellation_render_mode_evaluation_shader_propagate_nans, 2, 2);
                                               ...
                                               const struct V3D41_TESSELLATION_GEOMETRY_COMMON_PARAMS * restrict values)
{
   ...
   cl[ 3] = __gen_uint(values->reserved, 0, 7);

}

#define V3D41_TESSELLATION_GEOMETRY_COMMON_PARAMS_length      4
#ifdef __gen_unpack_address
static inline void
                                  ...
                                  const struct V3D41_TMU_CONFIG_PARAMETER_2 * restrict values)
{
   ...
   cl[ 1] = __gen_sint(values->offset_t, 4, 7) |
            __gen_sint(values->offset_s, 0, 3);

   cl[ 2] = __gen_uint(values->op, 4, 7) |
            __gen_sint(values->offset_r, 0, 3);

   cl[ 3] = __gen_uint(values->pad, 0, 7);
...
{
   values->pad = __gen_unpack_uint(cl, 24, 31);
