mkdir -p prebuilt-intermediates/{glsl,main,nir,spirv,cle,v3dv,util}
...
python src/broadcom/vulkan/v3dv_entrypoints_gen.py --xml src/vulkan/registry/vk.xml --outdir prebuilt-intermediates/v3dv/
